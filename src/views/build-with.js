...
import BuildWithSlider from '../components/build-with-slider'
import './build-with.css'

const BuildWith = (props) => {
  return (
    <div className="build-with-container">
      <Helmet>
        <title>Build-with - Seite105</title>
        <meta
          name="description"
          content="Poket-Leitfaden für die Gestaltung nachhaltiger Websites und die Optimierung bestehender Websites."
        />
        <meta property="og:title" content="Build-with - Seite105" />
        <meta
      ...
      <Link to="/analyse" className="build-with-navlink">
        <ABackbutton className="build-with-component"></ABackbutton>
      </Link>
      <BuildWithSlider></BuildWithSlider>
    </div>
  )
}
